...
var currentSvg = null;
var svgDetails = {
svg1: { path: 'media/SVG/police.svg', width: '50px', height: '50px' },
svg2: { path: 'media/SVG/police.svg', width: '50px', height: '50px' },
svg3: { path: 'media/SVG/police.svg', width: '50px', height: '50px' }
};
